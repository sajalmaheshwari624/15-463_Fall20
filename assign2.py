...
if __name__ == "__main__" :
	...
	hdr_image, im_name = get_hdr_image(args.hdr_folder_path, args.weight, args.isLinear, args.merging)
	if args.evaluate_hdr == True :
		error = evaluate_hdr_image(im_name)
		print (error)
	wb_image, wb_name = get_wb_image(im_name)
	tonemapped_im = tone_mapping(wb_name, args.K, args.B, args.color_space)
